 ...
 * </p>
 * <ul>
 *   <li>{@link blocky.impl.GameImpl#getLevels <em>Levels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GameImpl extends MinimalEObjectImpl.Container implements Game {
	...
	protected EClass eStaticClass() {
		return BlockyPackage.Literals.GAME;
	}
	...
	public EList<Level> getLevels() {
		if (levels == null) {
			levels = new EObjectContainmentEList<Level>(Level.class, this, BlockyPackage.GAME__LEVELS);
		}
		return levels;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case BlockyPackage.GAME__LEVELS:
